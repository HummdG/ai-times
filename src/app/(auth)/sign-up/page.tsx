      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-ink-muted text-sm mt-2">
            Subscribe to access our weekly AI intelligence briefing
          </p>
        </div>
        ...
        <div className="bg-white p-8 shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
          ...
          <div className="text-center mb-6 pb-6 border-b border-divider">
            <p className="text-xs uppercase tracking-widest text-ink-muted font-semibold mb-2">Premium Subscription</p>
            <div className="flex items-baseline justify-center gap-1">
              <span className="font-serif text-4xl font-bold text-ink">&pound;9.99</span>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-xs uppercase tracking-wider font-semibold text-ink-muted">
                Full Name
              </Label>
              <Input
                id="name"
